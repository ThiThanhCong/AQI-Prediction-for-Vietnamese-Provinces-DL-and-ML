...
\begin{figure}[H]
    \centering
    \subfigure[Tỉ lệ 9:1]{
        \includegraphics[width=0.48\textwidth]{bibliography/figure/RNN/9_1.png}
    }
    \hspace{0.01\textwidth}
    \subfigure[Tỉ lệ 8:2]{
        \includegraphics[width=0.48\textwidth]{bibliography/figure/RNN/8_2.png}
    }
    \hspace{0.01\textwidth}
    \subfigure[Tỉ lệ 7:3]{
        \includegraphics[width=0.48\textwidth]{bibliography/figure/RNN/7_3.png}
    }
...
\begin{figure}[H]
    \centering
    \subfigure[Tỉ lệ 9:1]{
        \includegraphics[width=0.48\textwidth, height=2cm]{bibliography/figure/LSTM/9_1.png}
    }
    \hspace{0.01\textwidth}
    \subfigure[Tỉ lệ 8:2]{
        \includegraphics[width=0.48\textwidth, height=2cm]{bibliography/figure/LSTM/8_2.png}
    }
    \hspace{0.01\textwidth}
    \subfigure[Tỉ lệ 7:3]{
        \includegraphics[width=0.48\textwidth, height=2cm]{bibliography/figure/LSTM/7_3.png}
    }
...
\begin{figure}[htbp]
    ...
    \subfigure[Kết quả dự đoán 30 ngày kết tiếp]{
        \includegraphics[width=0.48\textwidth]{bibliography/figure/RNN/predict_30_days.jpg}
    }
    \hspace{0.01\textwidth}
    \subfigure[Kết quả dự đoán 60 ngày kết tiếp]{
        \includegraphics[width=0.48\textwidth]{bibliography/figure/RNN/predict_60_days.jpg}
    }
    \hspace{0.01\textwidth}
    \subfigure[Kết quả dự đoán 90 ngày kết tiếp]{
        \includegraphics[width=0.48\textwidth]{bibliography/figure/RNN/predict_90_days.jpg}
    }
...
\begin{figure}[htbp]
    \centering
    \subfigure[Kết quả dự đoán 30 ngày kết tiếp]{
        \includegraphics[width=0.48\textwidth]{bibliography/figure/LSTM/predict_30_days.png}
    }
    \hspace{0.01\textwidth}
    \subfigure[Kết quả dự đoán 60 ngày kết tiếp]{
        \includegraphics[width=0.48\textwidth]{bibliography/figure/LSTM/predict_60_days.png}
    }
    \hspace{0.01\textwidth}
    \subfigure[Kết quả dự đoán 90 ngày kết tiếp]{
        \includegraphics[width=0.48\textwidth]{bibliography/figure/LSTM/predict_90_days.png}
    }
