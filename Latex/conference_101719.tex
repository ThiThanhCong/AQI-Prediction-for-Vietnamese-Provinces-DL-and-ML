...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|}
        ...
        \hline
        \multirow{2}{*}{GNN}    & 7:3              & 99.755  & 106.15         & 83.293  \\ &  \textbf{8:2} & \textbf{50.950} & \textbf{40.74} & \textbf{38.152}  \\ & 9:1 &. 51.968 & 76.15 & 46.458\\
        \hline
...
\subsubsection{Kết quả chạy mô hình}
RNN
\begin{figure}[H]
    \centering
    \subfigure[Tỉ lệ 9:1]{
    \includegraphics[width=0.3\textwidth]{bibliography/figure/RNN/9_1.png}
    }
    \hspace{0.01\textwidth}
    \subfigure[Tỉ lệ 8:2]{
    \includegraphics[width=0.3\textwidth]{bibliography/figure/RNN/8_2.png}
    }
    \hspace{0.01\textwidth}
    \subfigure[Tỉ lệ 7:3]{
    \includegraphics[width=0.3\textwidth]{bibliography/figure/RNN/7_3.png}
    }
    \caption{Kết quả chạy mô hình RNN}
    \label{fig
    }
\end{figure}
...
\begin{figure}[H]
    \centering
    \subfigure[Tỉ lệ 9:1]{
    \includegraphics[width=0.3\textwidth, height=2cm]{bibliography/figure/LSTM/9_1.png}
    }
    \hspace{0.01\textwidth}
    \subfigure[Tỉ lệ 8:2]{
    \includegraphics[width=0.3\textwidth, height=2cm]{bibliography/figure/LSTM/8_2.png}
    }
    \hspace{0.01\textwidth}
    \subfigure[Tỉ lệ 7:3]{
    \includegraphics[width=0.3\textwidth, height=2cm]{bibliography/figure/LSTM/7_3.png}
    }
    \caption{Kết quả chạy mô hình LSTM}
    \label{fig
    }
\end{figure}

\subsection{Dự đoán giá trị AQI trong 30, 60 và 90 ngày kế tiếp của bộ dữ liệu HaNoi's AQI}
\subsubsection{Kết quả của mô hình RNN với tỉ lệ chia tập kiểm tra và huấn luyện là}
9:1

\begin{figure}[htbp]
   
    \centering
    \subfigure[Kết quả dự đoán 30 ngày kết tiếp]{
    \includegraphics[width=0.2\textwidth]{bibliography/figure/RNN/predict_30_days.jpg}
    }
    \hspace{0.01\textwidth}
    \subfigure[Kết quả dự đoán 60 ngày kết tiếp]{
    \includegraphics[width=0.2\textwidth]{bibliography/figure/RNN/predict_60_days.jpg}
    }
    \hspace{0.01\textwidth}
    \subfigure[Kết quả dự đoán 90 ngày kết tiếp]{
    \includegraphics[width=0.2\textwidth]{bibliography/figure/RNN/predict_90_days.jpg}
    }
    \caption{Kết quả dự đoán giá trị AQI 30, 60 và 90 ngày kết tiếp của mô hình RNN}
    \label{fig
    }
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \subfigure[Kết quả dự đoán 30 ngày kết tiếp]{
    \includegraphics[width=0.2\textwidth]{bibliography/figure/LSTM/predict_30_days.png}
    }
    \hspace{0.01\textwidth}
    \subfigure[Kết quả dự đoán 60 ngày kết tiếp]{
    \includegraphics[width=0.2\textwidth]{bibliography/figure/LSTM/predict_60_days.png}
    }
    \hspace{0.01\textwidth}
    \subfigure[Kết quả dự đoán 90 ngày kết tiếp]{
    \includegraphics[width=0.2\textwidth]{bibliography/figure/LSTM/predict_90_days.png}
    }
