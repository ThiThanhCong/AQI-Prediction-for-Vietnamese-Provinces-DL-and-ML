...
\begin{figure}[htbp]
    ...
    \subfigure[Kết quả dự đoán 30 ngày kết tiếp]{
        \includegraphics[width=0.4\textwidth]{bibliography/figure/RNN/predict_30_days.jpg}
    }
    \hspace{0.01\textwidth}
    \subfigure[Kết quả dự đoán 60 ngày kết tiếp]{
        \includegraphics[width=0.4\textwidth]{bibliography/figure/RNN/predict_60_days.jpg}
    }
    \hspace{0.01\textwidth}
    \subfigure[Kết quả dự đoán 90 ngày kết tiếp]{
        \includegraphics[width=0.4\textwidth]{bibliography/figure/RNN/predict_90_days.jpg}
    }
...
\begin{figure}[htbp]
    \centering
    \subfigure[Kết quả dự đoán 30 ngày kết tiếp]{
        \includegraphics[width=0.4\textwidth]{bibliography/figure/LSTM/predict_30_days.png}
    }
    \hspace{0.01\textwidth}
    \subfigure[Kết quả dự đoán 60 ngày kết tiếp]{
        \includegraphics[width=0.4\textwidth]{bibliography/figure/LSTM/predict_60_days.png}
    }
    \hspace{0.01\textwidth}
    \subfigure[Kết quả dự đoán 90 ngày kết tiếp]{
        \includegraphics[width=0.4\textwidth]{bibliography/figure/LSTM/predict_90_days.png}
    }
